...
Entity clustering exists as an experimental side module. It is not integrated
into the main localization workflow yet. Tag preprocessing is also future work.
...
- `tests/test_template_workflow.py`: main regression tests for workflow, CLI,
  compatibility shims, schema errors, and default paths.
...
- TM extraction currently produces 19,403 reusable units.
- Extract with TM prefill currently fills 1,331 units covering 4,530 rows.
...
- The default test command should discover 24 tests at the time of this note.
...
- The current worktree may contain a user `.gitignore` change for `/testfiles/`.
  Do not revert or stage it unless the user asks.

## Recent Useful Commits

- `6ac6d57 Clarify default output filenames`
- `22ca83a Close workbooks after Excel IO`
- `2d69f8d Wire schema and user-facing errors`
- `ab54313 Move CLI and interactive code into modules`
- `53d4359 Move workflow orchestration into workflow module`
...
- Add tag preprocessing before template extraction.
