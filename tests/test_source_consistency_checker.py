...
class SourceConsistencyExcelTests(unittest.TestCase):
    ...
    def test_process_excel_lists_every_row_in_inconsistent_source_groups(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertEqual(problem_sheet["D2"].value, "3 种译法：1: Bonjour；2: Salut；3: Third translation")
            ...
            self.assertEqual(problem_sheet["D5"].value, "2 种译法：1: [空译文]；2: Translation")
